  ...
  return (
    (<div className="min-h-screen w-screen p-[75px] bg-blue-50 relative">
      <Button
        ...
        className="absolute top-4 right-4 bg-white hover:bg-blue-100 text-blue-800 border border-neutral-200 border-blue-200 dark:border-neutral-800">
      ...
      <Button
        onClick={() => router.push("/")}
        className="mt-4 bg-white hover:bg-blue-100 text-blue-800 border border-neutral-200 border-blue-200 dark:border-neutral-800">
        Back to HR Database
      </Button>
    </div>)
  );
